...
class Feud {
  ...
  static async create(feudData) {
    const result = await db('feuds').insert({
      ...
      madeira: feudData.madeira || INITIAL_RESOURCES.madeira,
      pedra: feudData.pedra || INITIAL_RESOURCES.pedra,
      ferro: feudData.ferro || INITIAL_RESOURCES.ferro,
      comida: feudData.comida || INITIAL_RESOURCES.comida,
      cobre: feudData.cobre || INITIAL_RESOURCES.cobre,
      pergaminhos: feudData.pergaminhos || INITIAL_RESOURCES.pergaminhos,
      cristais: feudData.cristais || INITIAL_RESOURCES.cristais,
      minério_raro: feudData.minério_raro || INITIAL_RESOURCES.minério_raro,
